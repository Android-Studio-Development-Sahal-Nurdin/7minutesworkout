...
import hal.tutorials.a7minutesworkout.databinding.ItemExerciseStatusBinding
...
//        14 add this code to display change color the current exercise
        when{
            model.getIsSelected() -> {
            ...
            else -> { // default yang belum di selected
