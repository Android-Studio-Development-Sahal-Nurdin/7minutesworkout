...
import hal.tutorials.a7minutesworkout.databinding.ActivityBmiBinding
import java.math.BigDecimal
import java.math.RoundingMode

class BMIActivity : AppCompatActivity() {
    //  20 Added variables for METRIC and US UNITS views and a variable for displaying the current selected view..)
//  START
    companion object {
...
//        20
        ...
        // 20 Adding a check change listener to the radio group and according to the radio button.)
...
//        18 add this code: THE BMI LOGIC CALCULATION
...
//    20 Making a function to make the METRIC UNITS view visible.
    /**
    ...
    //    18: add this code for bmi display result
    private fun displayBMIResult(bmi: Float) {
        ...
        if (bmi.compareTo(15f) <= 0) {
            ...
            bmiDescription = "OMG! You ina a very dangerous condition! Act now!"
        } else {
            bmiLabel = "Obese Class | (Very Severely obese)"
            bmiDescription = "OMG! You ina a very dangerous condition! Act now!"
        }
//    ini digunakan untuk format dari angka bmi
